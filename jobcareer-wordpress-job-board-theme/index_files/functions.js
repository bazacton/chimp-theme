 ...
 */
function chimpstudio_mailchimp_submit(theme_url, counter, admin_url) {
    "use strict";
    $ = jQuery;
    ...
    $.ajax({
        type: 'POST',
        url: admin_url,
        data: $('#mcform_' + counter).serialize() + '&action=chimpstudio_mailchimp',
 ...
 */
function chimpstudio_banner_count_plus(ajax_url, id) {
    'use strict';
    var dataString = 'code_id=' + id + '&action=chimpstudio_banner_count_plus';
    jQuery.ajax({
        type: "POST",
        url: ajax_url,
        data: dataString,
